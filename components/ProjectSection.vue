...
<template>
  <div
    ...
    id="projects"
  >
    <div class="flex items-center justify-between mb-6.4rem">
      <h3 class="flex items-center gap5 text-3rem">
        <div class="i-mdi-stack-overflow text-blue-700 text-3.2rem" />
        My Projects
      </h3>
      <Button
        gotoid="https://github.com/ihtisham914"
